...
from penzion.views import (HomeView, OkoliView, KontaktView, CenikView, PokojeView, FotogalerieView, UbytovaniView,
                           ReservationView)
...
urlpatterns = [
    ...
    path('ubytovani', UbytovaniView.as_view(), name='ubytovani'),
]
